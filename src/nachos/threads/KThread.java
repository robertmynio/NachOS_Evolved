...
public class KThread {
	...
	public static KThread currentThread() {
		Lib.my_assert(currentThread != null);
	...
	public KThread setTarget(Runnable target) {
		Lib.my_assert(status == statusNew);
	...
	private void begin() {
		...
		Lib.my_assert(this == currentThread);
	...
	public static void yield() {
		...
		Lib.my_assert(currentThread.status == statusRunning);
	...
	public void ready() {
		...
		Lib.my_assert(Machine.interrupt().disabled());
		Lib.my_assert(status != statusReady);
	...
	protected void restoreState() {
		...
		Lib.my_assert(Machine.interrupt().disabled());
		Lib.my_assert(this == currentThread);
		Lib.my_assert(tcb == TCB.currentTCB());
